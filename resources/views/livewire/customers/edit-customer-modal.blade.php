<div x-data="{ isEditCustomerModalOpen: @entangle('isEditCustomerModalOpen') }" class="relative z-40"
    aria-labelledby="modal-title" role="dialog" aria-modal="true" x-show="isEditCustomerModalOpen"
    x-on:close-edit-customer-modal.window="isEditCustomerModalOpen = false" x-cloak>
    <!--
      ...
      Leaving: "ease-in duration-200"
        ...
        To: "opacity-0"
    -->
    <div class="fixed inset-0 bg-gray-500/75 transition-opacity" aria-hidden="true" x-show="isEditCustomerModalOpen"
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        ...
        -->
            <div @click.away="isEditCustomerModalOpen = false" @keydown.escape.window="isEditCustomerModalOpen = false"
                x-show="isEditCustomerModalOpen" x-transition.duration
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div @click="isEditCustomerModalOpen = false">
                ...
                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <button type="button" @click="$wire.editCustomer()" wire:loading.attr="disabled"
                    ...
                    <button type="button" @click="isEditCustomerModalOpen = false"
