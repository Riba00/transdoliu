<div x-data="{ isCreateUserModalOpen: false }" class="relative z-40" aria-labelledby="modal-title" role="dialog"
    aria-modal="true" x-show="isCreateUserModalOpen"
    x-on:open-create-user-modal.window="isCreateUserModalOpen = true"
    x-on:close-user-create-modal.window="isCreateUserModalOpen = false" x-cloak>
    <!--
      ...
      Leaving: "ease-in duration-200"
        ...
        To: "opacity-0"
    -->
    <div class="fixed inset-0 bg-gray-500/75 transition-opacity" aria-hidden="true" x-show="isCreateUserModalOpen"
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        ...
        -->
            <div @click.away="isCreateUserModalOpen = false" @keydown.escape.window="isCreateUserModalOpen = false"
                x-show="isCreateUserModalOpen" x-transition.duration
                class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div class="flex items-center justify-between">

                    <div class="flex items-center">
                        <h3 class="text-sm sm:text-xl font-semibold text-gray-900" id="modal-title">CREATE NEW USER
                        </h3>
                    </div>

                    <div @click="isCreateUserModalOpen = false">
                ...
                <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    <button type="button" @click="$wire.createUser()" wire:loading.attr="disabled"
                    ...
                    <button type="button" @click="isCreateUserModalOpen = false"
