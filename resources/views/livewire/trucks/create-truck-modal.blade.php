<div x-data="{ isCreateTruckModalOpen: false }" class="relative z-40" aria-labelledby="modal-title" role="dialog"
    ...
    <!--
      ...
      Leaving: "ease-in duration-200"
        ...
        To: "opacity-0"
    -->
    <div class="fixed inset-0 bg-gray-500/75 transition-opacity" aria-hidden="true" x-show="isCreateTruckModalOpen" x-transition.duration></div>
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        ...
        -->
            <div @click.away="isCreateTruckModalOpen = false" @keydown.escape.window="isCreateTruckModalOpen = false" x-show="isCreateTruckModalOpen" x-transition.duration
